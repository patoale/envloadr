...
describe('parseEnvFiles', () => {
  ...
  describe('if override flag is activated', () => {
    it('should override the value of env vars to the last appearance when their names are duplicated in different files', () => {
      const files = {
        mock1: {
          name: '.mock1.env',
          content: [
